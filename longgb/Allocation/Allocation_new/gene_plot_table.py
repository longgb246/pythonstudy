...
if __name__=="__main__":
    ...
    sample_data=pd.read_csv("D:/Lgb/ReadData/actual/table_sample_sku_sample_select.csv",date_parser='date_s')
    ...
    for s in sku_set:
        for fdc in fdc_set:
            ...
            p1.set_ylim(np.min(tmp_data['inv'])-2,np.max(tmp_data['inv'])+2)
            #绘画预测7天销量和实际销量对比图
            print x_lab
