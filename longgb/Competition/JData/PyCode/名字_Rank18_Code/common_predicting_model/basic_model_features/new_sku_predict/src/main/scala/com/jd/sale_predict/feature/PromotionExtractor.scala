...
object PromotionExtractor {
  def extract(sc: SparkContext, projectPath: String,
    ...
    val rulePath = projectPath + "/data/{other_promotion_rule.csv,promotion_rule.csv}"
    ...
    val coveragePath = projectPath + "/data/{other_promotion_coverage.csv,promotion_coverage.csv}"
    ...
    val recordPath = projectPath + "/data/{other_promotion_record.csv,promotion_record.csv}"
