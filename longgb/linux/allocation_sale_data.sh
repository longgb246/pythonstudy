...
insert overwrite table dev.dev_allocation_sale_data partition(dt,dc_id)
	select
	 	a.org_dc_id,
		a.sale_ord_det_id,	
    a.sale_ord_id,		
    ...
    a.item_sku_id,
		...
		a.sale_ord_tm	,
	  	...
	  	case when c.sale_ord_id is not null then 'fdc_rdc'
	  	case when d.sale_ord_id is not null then 'fdc'
	  	else 'other' end,
	  	d.white_flag,
	...
	on 
		a.item_sku_id=d.sku_id and a.sale_ord_dt=d.date_s;"
