...
hive_final = '''set hive.exec.dynamic.partition=true;
         set hive.exec.dynamic.partition.mode=nonstrict;
         CREATE TABLE IF Not EXISTS dev.dev_allocation_sku_data
         ( sku_id    string,
                   forecast_begin_date       string,
        ...
        insert OVERWRITE table dev.dev_allocation_sku_data partition(date_s,dc_id)
                   ...
                   case when c.modify_time is not null and a.dt>c.create_time then 1
                   else 0 end white_flag_01,
                   a.dt as date_s,
                   b.dc_id
         FROM
                   (SELECT
         ...
         LEFT JOIN
             ...
             a.sku_id=d.sku_id AND
                     a.dt=d.dt;
'''
hive_final = Template(hive_final)
