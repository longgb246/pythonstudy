...
if __name__ == '__main__':
    HMMLgbIns = HMMLgb()
    words = u'''报道称，日本一直拒绝与美国进行双边贸易谈判。此前路透社报道称，日本副首相麻生太郎3月29日排除了与美国就双边贸易协议举行会谈的可能性，他强调这样的协议对日本没有好处。麻生表示，日本不应加入双边自贸协定（FTA）谈判来换取豁免钢铝关税，“当两个国家谈判时，强者恒强，只会给日本带来不必要的痛苦。”菅义伟也提醒称，关于美国重新加入TPP的任何谈判都可能面临挑战，因为11个签署国可能并不愿再与美国重启此前相关问题的谈判。菅义伟称，TPP协议就像“易碎的玻璃”，“要把一部分提出来重新谈判，将会非常困难。”
    '''
