...
#将上一天的期末库存作为第二天的初始库存，更新start_Date
...
# for index,row in orders_retail_mid.iterrows():
#     print '----', {row['id']:{row['item_sku_id']:row['sale_qtty']}}
#     print  row['dc_date_id'] in orders_retail
#     print  '7800000',row['dc_date_id'] , orders_retail,
