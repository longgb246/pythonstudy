...
# =======================================================================
# 路径
report_path = r'D:\Lgb\ReadData\sim'
save_path = r'D:\Lgb\ReadData\sim'
...
if __name__ == '__main__':
    ...
    for fdc in ['628', '630', '658']:
        ...
        plot_kpi_ito(Kpi_report_tmp, fdc, size=(12, 8), step=1)
    plot_kpi_fill(Kpi_report, 'Total', size=(18, 12), step=0.02)
    plot_kpi_ito(Kpi_report, 'Total', size=(18, 12), step=2)
