...
if __name__ == '__main__':
    ...
    tmp_fdc_simu_orders_retail = fdc_simu_orders_retail_pd['sale_qtty'].groupby([fdc_simu_orders_retail_pd["date_s"],
                                fdc_simu_orders_retail_pd["fdc"], fdc_simu_orders_retail_pd["sku"]]).sum()
    ...
    tmp_table_fill_01 = fdc_simu_orders_retail_pd['sale_ord_id'].groupby([fdc_simu_orders_retail_pd["fdc"],
                        fdc_simu_orders_retail_pd["date_s"]]).nunique().reset_index()
