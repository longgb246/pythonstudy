...
import numpy as np
from inventory_process import inventory_proess
import configServer
import  logging
...
sale_data_path=configServer.sale_data_path
...
#                                         'item_third_cate_c','item_second_cate_cd','date_s','shelves_dt,shelves_tm'])
...
# pickle.dump(allocation.fdc_inv,open(save_data_path+'fdc_inv','w'))
pickle.dump(white_list_dict,open(save_data_path+'white_list_dict','w'))
# pickle.dump(allocation.fdc_allocation,open(save_data_path+'fdc_allocation','w'))
# pickle.dump(allocation.rdc_inv,open(save_data_path+'rdc_inv','w'))
# pickle.dump(allocation.order_list,open(save_data_path+'order_list','w'))
# pickle.dump(allocation.orders_retail,open(save_data_path+'orders_retail','w'))
