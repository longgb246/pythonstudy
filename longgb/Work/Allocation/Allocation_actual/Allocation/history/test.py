...
pkl_sku.close()
# allocation_sku_data=allocation_sku_data.iloc[:100,]
...
print allocation_fdc_initialization.head()
print 'fdc数据库存'
print allocation_fdc_initialization[allocation_fdc_initialization['sku_id']==1468837]
...
print 'RDC库存...'
print tmp_df.head()
print tmp_df[tmp_df['sku_id']==1468837]
...
print '初始化rdc库存',rdc_inv['2016-10-02rdc1468837']
print '初始化fdc库存',fdc_inv['2016-10-026301468837']['inv']
#print all_sku_list
