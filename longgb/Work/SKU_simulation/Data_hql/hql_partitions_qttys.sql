...
-- 1、dev.dev_tmp_lgb_allocation_qttys 表的数据从 2016-12-20 扩展到 12 月份的数据查看。  12-02开始 12-01号的库存数据没有。
...
-- 2、dev.dev_tmp_lgb_combine_allocation_Forecast 表的数据从 2016-12-20 扩展到 12 月份的数据查看。
--      是基于 dev.dev_tmp_lgb_allocation_qttys 表的数据
set hive.exec.dynamic.partition=true;
set hive.exec.dynamic.partition.mode=nonstrict;
