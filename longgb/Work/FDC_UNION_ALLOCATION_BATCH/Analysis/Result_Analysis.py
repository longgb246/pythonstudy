...
def kpi_analysis():
    ...
    files = ['simulation_results_replace_std_7', 'simulation_results_inverse', 'system_all_sku_retail_inverse_system', 'sim_all_sku_retail_mix']
    suffix = ['_std_7', 'inverse', 'inverse_system', 'mix']
