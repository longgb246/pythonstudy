...
Parses a column containing a JSON string into a [[StructType]] or [[ArrayType]] of [[StructType]]s with the specified schema. Returns null, in the case of an unparseable string.
